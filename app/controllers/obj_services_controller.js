myAppControllers.controller('ServicesController', ["$scope", "$firebaseArray",
    function ServicesController($scope, $firebaseArray) {
        
var ref = new Firebase("https://ha-hair-proj.firebaseio.com/salonData/salonServices");
